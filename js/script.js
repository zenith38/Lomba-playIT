...
const allDetailsButtons = document.querySelectorAll('.ctn');
...
allDetailsButtons.forEach((button) => {
  button.addEventListener('click', (e) => {
    ...
    const eventDetails = button.parentNode;

    const explanationText = eventDetails.querySelector('.explanation').textContent;


    const modalContent = `
      <h2>${eventDetails.querySelector('h4').textContent}</h2>
      <p>${eventDetails.querySelector('p').textContent}</p>
      <img src="${eventDetails.querySelector('img').src}" alt="${eventDetails.querySelector('h4').textContent}">
      <p>${explanationText}</p>
